...
var getFFprobeWrappedExecution = function (input, ffprobePath) {
    return (0, execa_1.default)(ffprobePath, [
        '-v',
        'error',
        '-select_streams',
        'a:0',
...
var getAudioDurationInSeconds = function (absolutePathToFile, ffprobePath) { return __awaiter(void 0, void 0, void 0, function () {
    var stdout, _a, _b, _c, matched;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                _a = getFFprobeWrappedExecution;
                _b = [absolutePathToFile];
                if (!(ffprobePath !== null && ffprobePath !== void 0)) return [3 /*break*/, 1];
                _c = ffprobePath;
                return [3 /*break*/, 3];
            case 1: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require('@ffprobe-installer/ffprobe')); })];
            case 2:
                _c = (_d.sent()).path;
                _d.label = 3;
